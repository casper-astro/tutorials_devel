...
Start MATLAB via executing the :raw-html-m2r:`<code>startsg</code>` command, as described `here <https://casper-toolflow.readthedocs.io/en/latest/src/Running-the-Toolflow.html>`_. This ensures that necessary Xilinx and CASPER libraries are loaded into development environment by Simulink. When MATLAB starts up, open Simulink by typing :raw-html-m2r:`<i>simulink</i>` on the MATLAB command line. Start a new model, and save it with an appropriate name. **With Simulink, it is very wise to save early and often**.
...
#. The *CASPER DSP Library* contains (mostly green) blocks which inplement DSP functions, like filters, FFTs, etc.
...
.. image:: ../../_static/img/tut_intro/sysgen_select.png
   :target: ../../_static/img/tut_intro/sysgen_select.png
   :alt: 


Do not configure it directly, but rather add a platform block representing the system you care compiling for. These can be found in the :raw-html-m2r:`<i>CASPER XPS System Blockset</i>` library. For ROACH2, you need an XPS_core_config block.


.. image:: ../../_static/img/tut_intro/Casper_xps_blockset_default_final.png
   :target: ../../_static/img/tut_intro/Casper_xps_blockset_default_final.png
   :alt: 



.. image:: ../../_static/img/tut_intro/Casper_xps_blockset_hw_plat.png
   :target: ../../_static/img/tut_intro/Casper_xps_blockset_hw_plat.png
   :alt: 


Double click on the platform block that you just added. The :raw-html-m2r:`<i>Hardware Platform</i>` parameter should match the platform you are compiling for. For ROACH2 you have to set this from a drop-down list, for newer platforms it should automatically be set to the correct board type. Once you have selected a board, you need to choose where it will get its clock. In designs including ADCs you probably want the FPGA clock to be derived from the sampling clock, but for this simple design (which doesn't include an ADC) you should use the platform's on-board clock. To do this, set the :raw-html-m2r:`<i>User IP Clock Source</i>` to :raw-html-m2r:`<b>sys_clk</b>`. The sys_clk rate is 100 MHz, so you should set this for *User IP Clock Rate* in the block.
...
.. image:: ../../_static/img/tut_intro/counter_select.png
   :target: ../../_static/img/tut_intro/counter_select.png
   :alt: 
...
.. image:: ../../_static/img/tut_intro/Counter_params.png
   :target: ../../_static/img/tut_intro/Counter_params.png
   :alt: 
...
.. image:: ../../_static/img/tut_intro/Gpio_select.png
   :target: ../../_static/img/tut_intro/Gpio_select.png
   :alt: 
...
.. image:: ../../_static/img/tut_intro/Gpio_params_r2.png
   :target: ../../_static/img/tut_intro/Gpio_params_r2.png
   :alt: 
...
.. image:: ../../_static/img/tut_intro/SW_reg_select2.png
   :target: ../../_static/img/tut_intro/SW_reg_select2.png
   :alt: SW_reg_select2.png
...
.. image:: ../../_static/img/tut_intro/Slice_en.png
   :target: ../../_static/img/tut_intro/Slice_en.png
   :alt: 
...
.. image:: ../../_static/img/tut_intro/Slice_rst.png
   :target: ../../_static/img/tut_intro/Slice_rst.png
   :alt: 
...
.. image:: ../../_static/img/tut_intro/Add_sub_basic.png
   :target: ../../_static/img/tut_intro/Add_sub_basic.png
   :alt: 
...
.. image:: ../../_static/img/tut_intro/Add_sub_output.png
   :target: ../../_static/img/tut_intro/Add_sub_output.png
   :alt: 
...
.. image:: ../../_static/img/tut_intro/Counter_sim.png
   :target: ../../_static/img/tut_intro/Counter_sim.png
   :alt: 
...
.. image:: ../../_static/img/tut_intro/Adder_sim.png
   :target: ../../_static/img/tut_intro/Adder_sim.png
   :alt: 
...
#. You have a flashing LED,
#. A counter which you can start/stop/reset from software, and
#. A simple adder.
...
As per the previous figure, navigate to the outputs folder and (secure)copy this across to a test folder on the workshop server. Instructions to do this are available `here <https://casper.berkeley.edu/wiki/Casper_Caltech_Workshop_2017_Tutorials_Help_Page#Getting_your_designs_on_to_hardware_.3D>`_
