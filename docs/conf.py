...
# html_logo = '_static/img/cropped-casper_logo.png'
html_theme_options = {
...
htmlhelp_basename = 'CASPERTutorialsdoc'
...
latex_documents = [
    (master_doc, 'CASPERTutorials.tex', 'CASPER Tutorials Documentation',
...
man_pages = [
    (master_doc, 'caspertutorials', 'CASPER Tutorials Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'CASPERTutorials', 'CASPER Tutorials Documentation',
     author, 'CASPERTutorials', 'One line description of project.',
     'Miscellaneous'),
]
