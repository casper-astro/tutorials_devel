...
class skarab_adc_rx:
	...
	def ConfigAdcDdcMode(self, skarab):
		...
		for uADCSel in range(2,4):
			...
			skarab.transport.direct_spi_write(mezzanine_site, uADCSel, sd.ADC_JESD_CHAN_A_PLL_MODE, 0x00)
			skarab.transport.direct_spi_write(mezzanine_site, uADCSel, sd.ADC_JESD_CHAN_B_PLL_MODE, 0x00)
...
def plot_spectrum():
	...
	interleave_a = numpy.fft.fftshift(interleave_a)
	#interleave_a = 10*numpy.log10(interleave_a)
	print(numpy.linspace(-4096./2,4096./2-1,4096).shape,interleave_a.shape)
	matplotlib.pylab.plot(numpy.linspace(-4096./2,4096./2-1,4096)*750./4096.,interleave_a,'b')
