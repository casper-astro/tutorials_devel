...
if __name__=="__main__":
  ...
  p = OptionParser()
  p.set_usage('zcu216_tut_spec.py <HOSTNAME_or_IP> cx|real [options]')
  ...
  if opts.fpgfile != '':
    ...
    if mode == 1:
      fpg_prebuilt = '../prebuilt/zcu216/zcu216_tut_spec_cx.fpg'
    else:
      fpg_prebuilt = '../prebuilt/zcu216/zcu216_tut_spec.fpg'
