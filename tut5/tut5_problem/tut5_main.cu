...
int main(int argc, char *argv[])
{
    ...
    while (TRUE)
    {
        ...
        {
            /*****************************************************************/
            /* Task F: Copy accumulated spectra to host */
...
int Init()
{
    ...
    /*************************************************************************/
    /* Task A: Call cudaGetDeviceProperties() and get the maximum number of
               threads in a block, and store it in the variable
               iMaxThreadsPerBlock */
    ...
    if (g_iIsPFBOn)
    {
        ...
        /*********************************************************************/
        /* Task A: Copy filter coefficients to the device */
    ...
    /*************************************************************************/
    /* Task A: Calculate kernel parameters and store them in g_dimBPFB.x,
               g_dimBAccum.x, g_dimGPFB.x, and g_dimGAccum.x */
    ...
    /*************************************************************************/
    /* Task A: Create FFT plan using cufftPlanMany() */
